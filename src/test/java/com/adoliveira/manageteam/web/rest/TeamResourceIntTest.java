...
public class TeamResourceIntTest {
    ...
    private static final Boolean DEFAULT_ADVERSAIRE = false;
    private static final Boolean UPDATED_ADVERSAIRE = true;
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getNom()).isEqualTo(DEFAULT_NOM);
        assertThat(testTeam.isAdversaire()).isEqualTo(DEFAULT_ADVERSAIRE);
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].adversaire").value(hasItem(DEFAULT_ADVERSAIRE.booleanValue())))
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.adversaire").value(DEFAULT_ADVERSAIRE.booleanValue()))
    ...
    public void updateTeam() throws Exception {
        ...
        Team testTeam = teamList.get(teamList.size() - 1);
        assertThat(testTeam.getNom()).isEqualTo(UPDATED_NOM);
        assertThat(testTeam.isAdversaire()).isEqualTo(UPDATED_ADVERSAIRE);
